...
void main() async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpAndSettle();
      expect(find.byType(CreateTreatment), findsOneWidget);
      await Future.delayed(const Duration(seconds: 3));
      expect(find.text('Tambahkan Treatment'), findsOneWidget);
      await Future.delayed(const Duration(seconds: 2));
      await tester.enterText(find.byType(TextFormField).first, 'Contoh Jenis Treatment');
      await Future.delayed(const Duration(seconds: 2));
